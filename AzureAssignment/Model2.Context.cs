...
namespace AzureAssignment
{
    ...
    public partial class LibraryEntities1 : DbContext
    {
        ...
        [DbFunction("LibraryEntities1", "fn_Booklist")]
        public virtual IQueryable<fn_Booklist_Result> fn_Booklist(string user_id, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_Booklist_Result>("[LibraryEntities1].[fn_Booklist](@user_id, @password)", user_idParameter, passwordParameter);
        }
